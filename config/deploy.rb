# This is Dan Benjamin's EE Deploy Recipe. Kudos to him. Read more about it here 
# hivelogic.com/articles/deploying-expressionengine-github-capistrano/
# I have added Josh Peeks Slicehost recipes as well to make it easier to fully automate slice setup and EE deployment.

require File.expand_path(File.dirname(__FILE__) + "/lib/capistrano/ext/slicehost")


# the name of your website - should also be the name of the directory
set :application, "madebyrhino.com"
set :user, "deploy"
#set this up if you have changed the default SSH port. Otherwise Capistrano will not be able to connect. Also do this once the initial slice:configure recipe has run.
set :port, 30000 
...
set :repository, "git@github.com:terjin/madebyrhino.git"
